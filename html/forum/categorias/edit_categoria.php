    ...
    <form class="form-horizontal" action="?view=categorias&mode=edit&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded"><!--muy importante el enctype  -->
      <fieldset>
        <div class="form-group">
          ...
          <div class="col-lg-10">
          <input type="text" class="form-control" name="nombre" placeholder="Nombre para la categoria"  value="<?php echo $_categorias[$_GET['id']]['nombre'];?>" required="" ><!--SE LE LLAMO name="nombre" PORQUE EN class.Categorias.php se le llamo asi empty($_POST['nombre'])   -->
        </div>
      </div>
      <div class="form-group">
