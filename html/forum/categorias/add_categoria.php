...
<?php include(HTML_DIR . 'overall/topnav.php'); ?>
 ...
 <!-- CONTENIDO -->
   ...
   <strong>Completado!</strong> La categoria fue creada.
   </div>';
   }
   ...
   <strong>Error!</strong> El nombre de la categoria no puede estar vacío.
   </div>
     ';
   }
    ?>
...
<div class="row">
  <div class="col-md_12">
    <form class="form-horizontal" action="?view=categorias&mode=add" method="POST" enctype="application/x-www-form-urlencoded"><!--muy importante el enctype  -->
      <fieldset>
