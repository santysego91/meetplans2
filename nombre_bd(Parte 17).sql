...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2018 a las 02:45:20
...
(2, 'Mi primer foro', 'Esta es la descripción', 5, 5, 2, 1, 'Prueba bbcode', 16),
(5, 'Segundo Foro', 'Descripcion corta del segundo foro', 0, 0, 3, 0, '', 0),
(6, 'Tercer foro', 'Descripcion corta del tercer foro', 1, 1, 3, 1, 'Tu información y tus derechos', 15),
(7, 'Cuarto Foro', 'Descripcion corta del Cuarto Foro', 0, 0, 3, 1, '', 0),
(8, 'Quinto Foro', 'Descripcion corta del Quinto foro', 0, 0, 3, 1, '', 0),
(9, 'Sexto foro', 'Descripcion corta del Sexto Foro', 1, 1, 2, 1, '', 0),
(10, 'Septima Categoria', 'Descripcion cat 7', 1, 1, 2, 1, '', 0),
(11, 'Hoááa ·$·\"EQW', 'sdf', 0, 0, 10, 1, '', 0),
(12, '☺☻♥Foro con caracteres Esp♦♣ ♠◙ ♂♀♪♫☼◄↕‼¶§ ▬ ', 'llkñ ); ret ert ernvbmhgjhg', 0, 0, 10, 1, '', 0),
(13, 'hmjnbjhg', 'jhk', 0, 0, 11, 1, '', 0);
...
(14, 'Opciones', 'Correos electrónicos y SMS. Si ya no quieres recibir nuestros comunicados por correo electrónico o SMS, accede a la opción \"Configuración de comunicación\" del apartado \"Cuenta\" de nuestro sitio web y desmarca los elementos que desees dar de baja. Alternativamente, haz clic en el enlace \"dar de baja\" en el correo electrónico o responde STOP (o lo que se indique) al mensaje de texto. Ten en cuenta que no puedes darte de baja de nuestra correspondencia relacionada con el servicio (los mensajes sobre los movimientos de tu cuenta, por ejemplo).\r\n\r\nNotificaciones. Puedes optar por recibir notificaciones automáticas de Netflix en el móvil. Si luego decides que prefieres no recibir esas notificaciones, desactívalas en los ajustes de tu dispositivo móvil.\r\n\r\nAnuncios basados en intereses. Los anuncios basados en intereses son anuncios online adaptados a tus potenciales intereses, estimados a partir de tu uso de diversas aplicaciones y sitios web de Internet. Si utilizas un navegador, las cookies y los contadores de visitas pueden servir para recopilar datos que permitan estimar tus posibles intereses. Si utilizas un dispositivo móvil, una tableta o un dispositivo de streaming que incluya un identificador de publicidad, ese identificador también puede servir para estimar tus posibles intereses. En el apartado \"Cookies y publicidad en Internet\" (más abajo), encontrarás información sobre tus opciones relacionadas con los anuncios de Netflix basados en intereses.', 10, 6, 1, 1, '13/10/18 - 20:40', 0, 0, 6, '13/10/18 - 20:40'),
...
(6, 'User2', 'c0784027b45aa11e848a38e890f8416c', 'santysego@gmail.com', 2, 1, '', '', '', 1539564233, '', 'noavatar.gif', 'Esta es la [b]firma[/b] del usuario    [url=http://google.com]URL[/url] [center][img]http://i65.tinypic.com/2ryg9pg.png[/img][/center]', 'Usuario', 18, '15/10/2018', 'Esta es la biografia del usuario'),
(7, 'User3', 'c0784027b45aa11e848a38e890f8416c', 'email@email.es', 0, 1, '', '', '', 1539563264, '', 'noavatar.gif', 'Esta es la [b]firma[/b] del usuario  \r\n\r\n[url=http://google.com]URL[/url]\r\n[center][img]http://i65.tinypic.com/2ryg9pg.png[/img][/center]', 'Usuario', 18, '15/10/2018', 'Esta es la biografia del usuario');
